...
IMDB_TEMPLATE = environ.get("IMDB_TEMPLATE", "<b>〓〓〓{message.from_user.mention}〓〓〓</b>\n\n<b>● ʀᴇꜱᴜʟᴛ : <a href={url}>{title}</a>\n\n⭐️ ɪᴍᴅʙ  {rating} | ⏰ ʀᴜɴ {runtime} ᴍɪɴ |\n📆 ʀᴇʟᴇᴀsᴇ ᴅᴀᴛᴇ : {release_date}</b>\n\n● <code>{genres}</code>\n● <code>languages</code>\n\n<b>★ ᴘᴏᴡᴇʀᴇᴅ ʙʏ</b> <a href='http://t.me/Cinimalokham'><b><i>ᴄɪɴɪᴍᴀʟᴏᴋʜᴀᴍ</i></b></a>")
