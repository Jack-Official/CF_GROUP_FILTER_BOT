...
START_MESSAGE = environ.get('START_MESSAGE', '<b>𝐇ᴇʟʟᴏ{user}!</b>\n\n<b>𝐈 ᴄᴀɴ 𝐏ʀᴏᴠɪᴅᴇ 𝐌ᴏᴠɪᴇꜱ 𝐎ʀ 𝐒ᴇʀɪꜱᴇ, 𝐉ᴜꜱᴛ 𝐀ᴅᴅ 𝐌ᴇ 𝐓ᴏ 𝐘ᴏᴜʀ 𝐆ʀᴏᴜᴩ 𝐀ɴᴅ 𝐄ɴᴊᴏʏ.!</b>\n\n▢ <b>𝐌ᴀɪɴᴛᴀɪɴᴇᴅ 𝐁ʏ - <a href=https://t.me/cinema_flix_updates>𝐂ɪɴɪᴍᴀ 𝐅ʟɪx™</b></a>')
...
WELCOM_TEXT = environ.get("WELCOM_TEXT", "<b>𝐇ᴇʏ {user}\n𝐖ᴇʟᴄᴏᴍᴇ 𝐓ᴏ 𝐌ʏ 𝐆ʀᴏᴜᴩ {chat}\n\n⊶ 𝐓ʜᴀɴᴋꜱ 𝐅ᴏʀ 𝐉ᴏɪɴɪɴɢ 𝐌ʏ 𝐆ʀᴏᴜᴩ.!!🥹\n\n⊶ 𝐓ʏᴩᴇ 𝐀ɴʏ 𝐌ᴏᴠɪᴇ 𝐀ɴᴅ 𝐖ᴇʙ-𝐒ᴇʀɪᴇꜱ, 𝐍ᴀᴍᴇ 𝐀ɴᴅ 𝐄ɴᴊᴏʏ.!!🎉</b>")
