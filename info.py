...
START_MESSAGE = environ.get('START_MESSAGE', '<b><i>𝐇𝙴𝙻𝙻𝙾 {user}!</b></i>\n\n<b><i>𝐈 𝙲𝙰𝙽 𝐏𝚁𝙾𝚅𝙸𝙳𝙴 𝐌𝙾𝚅𝙸𝙴𝚂 𝐎𝚁 𝐒𝙴𝚁𝙸𝚂𝙴, 𝐉𝚄𝚂𝚃 𝐀𝙳𝙳 𝐌𝙴 𝐓𝙾 𝐘𝙾𝚄𝚁 𝐆𝚁𝙾𝚄𝙿𝚂 𝐀𝙽𝙳 𝐄𝙽𝙹𝙾𝚈.!</i></b>\n\n<b><i>▢ 𝐌𝙰𝙸𝙽𝚃𝙰𝙸𝙽𝙴𝙳 𝐁𝚈 - <a href=https://t.me/cinema_flix_updates>𝐂𝙸𝙽𝙴𝙼𝙰 𝐅𝙻𝙸𝚇™</i></b></a>')
...
WELCOM_TEXT = environ.get("WELCOM_TEXT", "<b><i>𝐇𝙴𝚈 {user}\n𝐖𝙴𝙻𝙲𝙾𝙼𝙴 𝐓𝙾 𝐌𝚈 𝐆𝚁𝙾𝚄𝙿 {chat}\n\n⊶ 𝐓𝙷𝙰𝙽𝙺𝚂 𝐅𝙾𝚁 𝐉𝙾𝙸𝙽𝙸𝙽𝙶 𝐌𝚈 𝐆𝚁𝙾𝚄𝙿.!🥹\n\n⊶ 𝐓𝚈𝙿𝙴 𝐀𝙽𝚈 𝐌𝙾𝚅𝙸𝙴 𝐀𝙽𝙳 𝐖𝙴𝙱-𝐒𝙴𝚁𝙸𝙴𝚂, 𝐍𝙰𝙼𝙴 𝐀𝙽𝙳 𝐄𝙽𝙹𝙾𝚈.!🎉</i></b>")
...
IMDB_TEMPLATE = environ.get("IMDB_TEMPLATE", "<b>🎬 𝐓itle : <a href={url}>{title}</a>\n\n⭐️ 𝐈ᴍᴅʙ {rating} | ⏰ 𝐑ᴜɴ {runtime} 𝐌ɪɴ |\n📆 𝐑ᴇʟᴇᴀsᴇ 𝐃ᴀᴛᴇ : {release_date}</b>\n\n🎭 <code>{genres}</code>\n🗞️ <code>{languages}</code>\n\n<blockquote>{message.chat.title}</blockquote>")
