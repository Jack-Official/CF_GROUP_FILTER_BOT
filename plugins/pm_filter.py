...
FILTER_MODE = {}
G_MODE = {}
NON_IMG ="""<b><i>👋𝐇𝙴𝚈 <a href=tg://settings>𝐌𝚈 𝐅𝚁𝙸𝙴𝙽𝙳</a></i></b>\n\n<b>⌯ <i>𝐔𝚂𝙴 𝐓𝙷𝙴 𝐁𝚄𝚃𝚃𝙾𝙽 𝐁𝙴𝙻𝙾𝚆 𝐓𝙾 𝐒𝙴𝙰𝚁𝙲𝙷 𝐎𝙽 𝐆𝙾𝙾𝙶𝙻𝙴 𝐎𝚁 𝐈𝙼𝙳𝙱 𝐀𝙽𝙳 𝐂𝙾𝙿𝚈 𝐓𝙷𝙴 𝐂𝙾𝚁𝚁𝙴𝙲𝚃 𝐌𝙾𝚅𝙸𝙴 𝐍𝙰𝙼𝙴 𝐀𝙽𝙳 𝐏𝙰𝚂𝚃𝙴.!</i></b>\n\n<b>⌯<i> 𝐃𝙾𝙽'𝚃 𝐀𝚂𝙺 𝐌𝙾𝚅𝙸𝙴𝚂 𝐓𝙷𝙰𝚃 𝐀𝚁𝙴 𝐍𝙾𝚃 𝐑𝙴𝙻𝙴𝙰𝚂𝙴𝙳 𝐈𝙽 𝐎𝚃𝚃 𝐏𝙻𝙰𝚃𝙵𝙾𝚁𝙼.!</i></b>\n\n<b>⌯ <i>𝐓𝚁𝚈 𝐓𝙾 𝐀𝚂𝙺 𝐈𝙽 [ 𝐌𝙾𝚅𝙸𝙴 𝐍𝙰𝙼𝙴, 𝐘𝙴𝙰𝚁 ] 𝐓𝙷𝙸𝚂 𝐅𝙾𝚁𝙼𝙰𝚃.!</i></b>\n\n<i><b><u>⚠️ 𝐃𝙾𝙽'𝚃 𝐔𝚂𝙴: ➲ [+:;'*!-&.. etc</i></b></u>"""
...
async def next_page(bot, query):
    ...
    if n_offset == 0:
        ...
        btn.append(
            [InlineKeyboardButton("❏ 𝐏ᴀɢᴇ", callback_data="pages"), 
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):        
        ...
        buttons = [[
            ...
            InlineKeyboardButton('𝐑ᴇғʀᴇꜱʜ ⏳', callback_data='rfrsh')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
...
async def auto_filter(client, msg, spoll=False):
    ...
    if offset != "":
        ...
        btn.append(
            [InlineKeyboardButton(text="💢..𝐍ᴏ 𝐌ᴏʀᴇ 𝐍ᴇxᴛ 𝐏ᴀɢᴇꜱ..💢", callback_data="pages")]
        )                   
    ...
    if imdb:
        ...
        cap = f"<b>🕵️ 𝐑ᴇϙᴜᴇsᴛᴇᴅ 𝐌ᴏᴠɪᴇ:</b> <code>{search}</code>\n<b>🗃️ 𝐓ᴏᴛᴀʟ 𝐑ᴇsᴜʟᴛs:</b> <b>{str(total_results)}</b>\n📬 𝐑ᴇϙᴜᴇsᴛᴇᴅ 𝐁ʏ:{message.from_user.mention}</b>\n\n<b><blockquote>{message.chat.title}</blockquote></b>"
